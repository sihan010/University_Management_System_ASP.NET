<%@ Page Title="School CRUD Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="SchoolCRUD.aspx.cs" Inherits="SchoolCRUD" %>
    ...
    <div class="row">      
         <div> 
             <div class="col-md-offset-3 col-md-6 col-md-offset-3 well">
                 ...
                 <p style="margin-left:25%">Number of Departments:<br></p>
                 <asp:TextBox ID="number" runat="server" CssClass="form-control col-md-offset-3"></asp:TextBox> <hr /> 
